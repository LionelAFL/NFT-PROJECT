...
<head>
  ...
  <title><?php echo $row['title'] ?></title>
	<link rel="icon" type="image/png" href="<?php echo $row['favicon']?>" sizes="32x32">
	<link rel="apple-touch-icon" href="<?php echo $row['favicon']?>">
  <!-- plugins:css -->
              ...
              <form class="pt-3" method="post">
                ...
                <div class="mt-3">
                  <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="SIGN IN" name="submit"/>
								...
								<h6 class="font-weight-light"><a href="forgot_password">forgot password</a></h6>
