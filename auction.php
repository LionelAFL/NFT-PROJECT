						...
						<div class="row">
							...
							<div class="col-12">
								<div class="sign__group">
									...
									<input type="text" name="name" class="sign__input" placeholder="e. g. 'Crypto Heart'" required>
								</div>
							</div>
							...
							<div class="col-12">
								<div class="sign__group">
									...
									<textarea id="description" name="details" class="sign__textarea" placeholder="e. g. 'After purchasing you will able to receive...'" required></textarea>
								</div>
							</div>
							...
							<div class="col-12 col-md-4">
								<div class="sign__group">
									...
									<select name="type" class="sign__select" required>
							...
							<div class="col-12 col-md-4">
								<div class="sign__group">
									<label class="sign__label" for="price">Min bidding price</label>
									<input type="text" name="price" class="sign__input" placeholder="price" required>
								</div>
							</div>
							...
							<div class="col-12 col-md-4">
								<div class="sign__group">
									...
									<select name="status" class="sign__select" required>
										<option value="2">Put on Auction</option>
									</select>
								</div>
							</div>

							<div class="col-12 col-xl-3">
								<button type="submit" class="sign__btn" name="submit">Auction</button>
							</div>
